...
class _TimePickerSpinnerState extends State<TimePickerSpinner> {
  ...
  void initState() {
    ...
    currentSelectedHourIndex =
        (0/*currentTime.hour*/ % (widget.is24HourMode ? 24 : 12)) + _getHourCount();
        ...
        children: <Widget>[
          new Positioned(
            ...
            child: Container(
              ...
              child: Container(
                width: _getItemWidth(),
                height: _getItemHeight() - 8,
                decoration: new BoxDecoration(
                  color: Color(0x1913D077), // 底色
                  borderRadius:
                      new BorderRadius.all(Radius.circular(4)), // 也可控件一边圆角大小
                ),
              ),
            ),
          ),
  ...
  Widget spinner(
    ...
    return new Stack(
      children: <Widget>[
        ...
        isScrolling ? Positioned.fill(child: new Container()) : new Container()
      ],
    );
  }
