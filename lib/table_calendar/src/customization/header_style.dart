...
class HeaderStyle {
  ...
  const HeaderStyle({
    ...
    this.titleTextStyle = const TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold),
    ...
    this.leftChevronMargin = const EdgeInsets.symmetric(horizontal: 0.0),
    this.rightChevronMargin = const EdgeInsets.symmetric(horizontal: 0.0),
...
//      borderRadius: const BorderRadius.all(Radius.circular(12.0)),
    ...
    this.todayButtonTextStyle = const TextStyle(fontSize: 16.0),
    this.todayButtonPadding = const EdgeInsets.symmetric(horizontal: 4.0, vertical: 4.0),
