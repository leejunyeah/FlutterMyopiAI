...
class _TableCalendarState extends State<TableCalendar>
  ...
  void _toggleTodayAction() {
    setState(() {
      _calendarLogic.setSelectedDayByTodayAction(DateTime.now(),
          isAnimated: true);
    });
  }
  ...
  Widget _buildHeader() {
    ...
    if (widget.headerStyle.formatButtonVisible &&
      ...
      children.insert(3, const SizedBox(width: 8.0));
      children.insert(4, _buildFormatButton());
    }
    ...
    final bottomHeader = Row(
      mainAxisSize: MainAxisSize.max,
      children: children,
    );

    final finalChildren = [topHeader, bottomHeader];
  ...
  Widget _buildTodayButton() {
    return InkWell(
      ...
      child: Container(
        ...
        child: Text(
          'Today',
          style: widget.headerStyle.todayButtonTextStyle,
        ),
      ),
    );
  }
